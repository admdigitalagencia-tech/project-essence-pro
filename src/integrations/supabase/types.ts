  ...
  public: {
    Tables: {
      data_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_sources_owner_user_id_fkey";
      ...
      imports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "imports_owner_user_id_fkey";
            columns: ["owner_user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
      ...
      weekly_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "weekly_reports_owner_user_id_fkey";
            columns: ["owner_user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
      ...
      work_origins: {
        ...
        Relationships: [
          {
            foreignKeyName: "work_origins_owner_user_id_fkey";
            columns: ["owner_user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
